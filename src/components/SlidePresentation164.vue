<template>
  <div class="slide">
    <div class="heading">HTTP Protocol detour - Response exemple</div>
    <div class="content">
      <p>
        Réponse HTTP à une demande de récupération de la page hello.htm sur le
        serveur web.
      </p>
      <br />
      <div class="codeblock">
        <pre style="margin: 0; line-height: 125%">
          HTTP<span style="color: #333333">/</span><span style="color: #6600EE; font-weight: bold">1.1</span> <span style="color: #0000DD; font-weight: bold">200</span> OK
