<template>
  <div class="slide">
    <div class="heading">PHP et HTML - Traitement des formulaires</div>
    <div class="content">
      <p>
        Sur le serveur, nous pouvons déterminer quel type de méthode a été
        utilisé pour accéder à la ressource.
      </p>
      <div class="codeblock">
