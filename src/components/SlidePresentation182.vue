<template>
  <div class="slide">
    <div class="heading">PHP et HTML - traitement séparé</div>
    <div class="content">
      <p>
        Nous pouvons écrire du HTML et afficher un formulaire et traiter le
        formulaire soumis avec un fichier php dédié.
      </p>
      <div class="codeblock">
