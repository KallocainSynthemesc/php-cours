<template>
  <div class="slide">
    <div class="heading">Opérateurs logiques - and</div>
    <div class="content">
      <p>
        Elle donne <b>True</b> si les <b>deux conditions</b> sont <b>True</b>.
        Et elle donne <b>False</b> si <b>l'une ou l'autre</b> des conditions a
        ou b est <b>False</b>.
      </p>
      <table class="tg" style="width: 100%; height: 50%">
        <thead>
          <tr>
            ...
            <th class="tg-0lax">
              <span style="font-weight: bold">a and b</span>
            </th>
          </tr>
        </thead>
        <tbody>
